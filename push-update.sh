...
if [ ! -f "$1" ]; then
   ...
   echo
   echo "The name of ZIP is assumed to have genesis-VERSION-DATE-TYPE-* as format"
...
# Assume genesis-VERSION-DATE-TYPE-*.zip
...
adb shell "killall org.genesisos.updater 2>/dev/null"
adb shell "sqlite3 /data/data/org.genesisos.updater/databases/updates.db" \
